                                                ...
                                                <div className="detail-carousel" id="detail_carousel">
                                                    <div className="image" data-index={0}>
                                                        <a
                                                            ...
                                                            href="https://img.freepik.com/premium-photo/realm-virtual-augmented-reality-ai_971989-4923.jpg"
                                                        >
                                                            <div className="figure">
                                                                ...
                                                                <div
                                                                    ...
                                                                    style={{
                                                                        backgroundImage:
                                                                            "url(https://img.freepik.com/premium-photo/realm-virtual-augmented-reality-ai_971989-4923.jpg)"
                                                                    }}
                                                                ></div>
                                                    ...
                                                    <div className="image" data-index={1}>
                                                        <a
                                                            className="waves-effect"
                                                            href="https://img.freepik.com/free-photo/science-cardiology-operation_587448-5010.jpg"
                                                        >
                                                            <div className="figure">
                                                                <img
                                                                    src="https://img.freepik.com/free-photo/science-cardiology-operation_587448-5010.jpg"
                                                                    alt="thumb"
                                                                />
                                                                <div
                                                                    className="img image-detail"
                                                                    style={{
                                                                        backgroundImage:
                                                                            "url(https://img.freepik.com/free-photo/science-cardiology-operation_587448-5010.jpg)"
                                                                    }}
                                                                ></div>
                                                                <i className="material-icons zoom-icon">zoom_in</i>
                                                            </div>
                                                    ...
                                                    <div className="image" data-index={2}>
                                                        <a
                                                            className="waves-effect"
                                                            href="https://img.freepik.com/free-photo/businessman-use-vr-virtual-reality-goggle-metaverse-technology_587448-4859.jpg"
                                                        >
                                                            <div className="figure">
                                                                <img
                                                                    src="https://img.freepik.com/free-photo/businessman-use-vr-virtual-reality-goggle-metaverse-technology_587448-4859.jpg"
                                                                    alt="thumb"
                                                                />
                                                                <div
                                                                    className="img image-detail"
                                                                    style={{
                                                                        backgroundImage:
                                                                            "url(https://img.freepik.com/free-photo/businessman-use-vr-virtual-reality-goggle-metaverse-technology_587448-4859.jpg)"
                                                                    }}
                                                                ></div>
                                                                <i className="material-icons zoom-icon">zoom_in</i>
                                                            </div>
                                        ...
                                        <div className="col-lg-6 col-sm-7 pa-13 px-md-10">
                                            <div className="text">
                                                <h4 className="use-text-title2">
                                                    <span className="use-text-subtitle2" /> Virtual Reality
                                                </h4>
                                                <article className="desc">
                                                    <h6 className="use-text-paragraph">
                                                        {" "}
                                                        Virtual Reality (VR) has redefined the way we engage with digital
                                                        content by immersing us in entirely virtual environments. Its
                                                        applications span diverse sectors, enriching entertainment
                                                        experiences, transforming educational methods, enhancing healthcare
                                                        practices, and optimizing industrial processes.
                                                    </h6>
                                                    <h6 className="use-text-p">
                                                        In healthcare, VR can revolutionize therapy and training. It allows
                                                        patients to undergo immersive rehabilitation and helps professionals
                                                        simulate complex procedures. VR, akin to IoT in data collection,
                                                        enhances efficiency and decision-making across industries,
                                                        presenting opportunities for healthcare and beyond.
                                                    </h6>
