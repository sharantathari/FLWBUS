          ...
          <nav className="nav-menu">
            ...
            <div className="scrollactive-nav scrollnav show-lg-up multi-menu">
              <ul className="main-menu">
                <li>
                  <a className="btn btn-flat anchor-link" href="#feature">
                    main feature
                  </a>
                </li>
                <li>
                  <a className="btn btn-flat anchor-link" href="#popular">
                    popular course
                  </a>
                </li>
                <li>
                  <a className="btn btn-flat anchor-link" href="#explore">
                    Tech Horizon
                  </a>
                </li>
                <li>
                  <Link className="btn btn-flat anchor-link" href="/blogs">
                    blogs
                  </Link>
                </li>
                <li>
                  <Link className="btn btn-flat anchor-link" href="/events">
                    events
                  </Link>
                </li>
                <li>
            ...
            <nav className="user-menu">
              ...
              <Link className="btn waves-effect primary show-sm-up" href="/register">
                register
              </Link>
